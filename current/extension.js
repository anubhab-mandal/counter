...
class counterExt extends Extension {
    ...
    enable() {
        ...
        Main.panel.addToStatusArea(this.uuid, this._indicator, this._settings.index, this._settings.alignment);
    }
    disable() {
        this._saveCounter();
        if (this._indicator) {
